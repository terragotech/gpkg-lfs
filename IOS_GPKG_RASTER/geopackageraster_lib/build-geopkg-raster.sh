...
echo CFLAGS ${CFLAGS}
echo ${CXX} ${CXXFLAGS} ${LDFLAGS} -c -o GeoPackageRasterReader.o 
${CXX} ${CXXFLAGS} ${LDFLAGS} -c -o GeoPackageRasterReader.o GeoPackageRasterReader.cpp
ar rcs libGeoPackageRasterReader.a GeoPackageRasterReader.o

mkdir ./install/
mkdir ./install/${arch}/
cp libGeoPackageRasterReader.a ./install/${arch}/libGeoPackageRasterReader.a
