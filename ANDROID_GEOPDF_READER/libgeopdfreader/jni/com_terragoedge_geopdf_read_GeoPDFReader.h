...
#include <jni.h>
	...
	JNIEXPORT jlong JNICALL Java_com_terragoedge_geopdf_read_GeoPDFReader_generateMBTiles(JNIEnv *, jobject, jlong, jstring, jstring,jstring,jstring,jstring,jstring,jstring);
