...
int geopdf_set_input_filename_gtt(struct gdal_tiles *gt,char *filename);
...
int geopdf_create_status_file_progress(char *id,double percentage);
int geopdf_create_status_file_failed(char *id, char *reason);
