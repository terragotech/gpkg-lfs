...
#include <jni.h>
	...
	JNIEXPORT jlong JNICALL Java_com_terragoedge_geopdf_read_GeoPDFReader64_generateMBTiles(JNIEnv *, jobject, jstring, jstring,jstring,jstring,jstring,jstring,jstring);
