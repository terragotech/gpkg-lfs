...
cd proj-4.8.0
echo ////////////////////////////////////////////////////////////
echo $PREFIX_PROJ/i386
./configure --prefix=$PREFIX_PROJ/i386 \
    --enable-shared=no \
   --enable-static=yes \
    --host=$host
echo ////////////////////////////////////////////////////////////
...
echo ////////////////////////////////////////////////////////////
echo $PREFIX_SQLITE/i386
./configure --prefix=$PREFIX_SQLITE/i386 --host=$host
echo ////////////////////////////////////////////////////////////
...
echo ./configure \
    ...
    --with-sse=no \
    --with-avx=no \
    --with-static-proj4=$PREFIX_PROJ/i386 \
    --with-sqlite3=$PREFIX_SQLITE/i386 \
...
make clean
make
mkdir -p $PREFIX_GDAL/i386
rm -f $PREFIX_GDAL/i386/libgdal.a
cp .libs/libgdal.a $PREFIX_GDAL/i386/libgdal.a
echo file copied
fi
