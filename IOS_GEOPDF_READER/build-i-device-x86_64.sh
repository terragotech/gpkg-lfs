...
cd proj-4.8.0
echo ////////////////////////////////////////////////////////////
echo $PREFIX_PROJ/x86_64
./configure --prefix=$PREFIX_PROJ/x86_64 \
    --enable-shared=no \
   --enable-static=yes \
    --host=$host
echo ////////////////////////////////////////////////////////////
...
echo ////////////////////////////////////////////////////////////
echo $PREFIX_SQLITE/x86_64
./configure --prefix=$PREFIX_SQLITE/x86_64 --host=$host
echo ////////////////////////////////////////////////////////////
...
echo ./configure \
    ...
    --with-sse=no \
    --with-avx=no \
    --with-static-proj4=$PREFIX_PROJ/x86_64 \
    --with-sqlite3=$PREFIX_SQLITE/x86_64 \
...
make clean
make
mkdir -p $PREFIX_GDAL/x86_64
rm -f $PREFIX_GDAL/x86_64/libgdal.a
cp .libs/libgdal.a $PREFIX_GDAL/x86_64/libgdal.a
echo file copied
fi
