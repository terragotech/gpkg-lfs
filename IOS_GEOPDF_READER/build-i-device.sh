...
cd proj-4.8.0
echo ////////////////////////////////////////////////////////////
echo $PREFIX_PROJ/armv7
./configure --prefix=$PREFIX_PROJ/armv7 \
    --enable-shared=no \
   --enable-static=yes \
    --host=$host
echo ////////////////////////////////////////////////////////////
...
echo ////////////////////////////////////////////////////////////
echo $PREFIX_SQLITE/armv7
./configure --prefix=$PREFIX_SQLITE/armv7 --host=$host
echo ////////////////////////////////////////////////////////////
...
echo ./configure \
    ...
    --with-sse=no \
    --with-avx=no \
    --with-static-proj4=$PREFIX_PROJ/armv7 \
    --with-sqlite3=$PREFIX_SQLITE/armv7 \
...
make clean
make
mkdir -p $PREFIX_GDAL/armv7
rm -f $PREFIX_GDAL/armv7/libgdal.a
cp .libs/libgdal.a $PREFIX_GDAL/armv7/libgdal.a
echo file copied
fi
