...
then
   echo Bad parameters
   echo example:
   echo ./build-proj-sqlite.sh android-ndk-r14b
else
export PATH=$PATH:$PWD/$1
echo $PATH
...
cp ./gdalh/*.h ./arm64-v8a/include/
cp ./gdalh/*.h ./armeabi/include/
cp ./gdalh/*.h ./armeabi-v7a/include/
cp ./gdalh/*.h ./mips/include/
cp ./gdalh/*.h ./mips64/include/
cp ./gdalh/*.h ./x86/include/
cp ./gdalh/*.h ./x86_64/include/
