...
cd gdal-2.1.0
./configure --host=arm-linux-androideabi --without-grib --with-static-proj4=$GDAL_TP_FOLDER/armeabi-v7a --with-sqlite3=$GDAL_TP_FOLDER/armeabi-v7a
make clean
make
cp .libs/libgdal.a $GDAL_TP_FOLDER/armeabi-v7a/lib/libgdal.a
fi
